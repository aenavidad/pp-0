...
\label{s:theories}
	...
	\subsection{Possible} % may name Neo-Wallacian or Campbellian/Restallian (if follows Campbell/Restall) - or give Wallacian w/ usual sense of state and emergence but for Bc+Id, then given Campbellian w/ looser sense of state or emergence but for Bc - then commercial vs mil/legal pressures theories
	\label{ss:possyfirst}
