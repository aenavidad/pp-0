...
\label{s:theories}
	...
	\label{ss:existing}
		...
		% use buccan/cuttg only - sx as work says what-where-when-how, so need this carving/this model for theory
		...
		\footnote{The Bulmer-Thomases seem to speak in terms of a collective, intentional, continuous state, but \emph{for} the model used here, we can imagine competing senses giving us this same theory.} % note their model is clearer to see than their carving
		% copy re their carving ↓
		...
		\footnote{In \citelist{\cite{cam03}*{pp~171, 174--176, 178--180} \cite{cam11}*{pp~vii, 82--84, 91--93, 95--96, 100, 104--108, 121--122, 129}}. Honduras emerged as xx. Cutting xx.}
		...
		\footnote{In \cite{fen49}*{p~3}. \ment{Wallace} read symbolically.}
		
		\subsubsection{Read's} % note bul16 pp~151-152 say 1642 Mulato Bacl sack may have been more than piratical (to force Sp to withdraw)
	...
	\label{ss:possible}
		xx.%
		\footnote{Theories haphazardly chosen. These seem to be at least as viable as existing theories.} % may note no ordered viability claim - may note does not exhaust viable theories
